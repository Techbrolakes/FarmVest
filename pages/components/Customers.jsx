        ...
        <div className="bg-[#F2F8F2] dark:bg-[#354046] bg-[url('/line.png')] dark:bg-[url('/darkline.png')] bg-center bg-no-repeat bg-cover rounded-md">
          <article className="flex flex-col justify-center items-center py-16">
            ...
            <div className="flex  mt-4">
              <button className="bg-black flex items-center hover:bg-primaryText text-white py-2 px-4 rounded-lg shadow-lg">
                <ImAppleinc size="32px" />
                <div className="text-left">
                  <h1 className="text-xs"> Available on the</h1>
                  <img src="/Vector.png" alt="icon" />
                </div>
              </button>
              <button className="bg-black ml-8 hover:bg-primaryText flex items-center text-white py-2 px-4 rounded-lg shadow-lg">
